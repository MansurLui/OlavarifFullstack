...
function verificarExponente(base:number, exponente:number) {
    if (exponente <0){
        console.log("Exponente invalido, ingrese uno mayor a 0");
    } else if (exponente==0){
        console.log("1");
    } else {
    console.log("la potencia de "+ base +" elevado a "+ exponente + " es " + calcularPotencia(base,exponente));
    }
}
...
verificarExponente(base,exponente);
